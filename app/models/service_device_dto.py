...
class ServiceDeviceModel(BaseModel):
    ...
    createdAt: Optional[datetime] = ServiceDeviceField.created_at
    updatedAt: Optional[datetime] = ServiceDeviceField.updated_at
...
class UpdateServiceDeviceModel(BaseModel):
