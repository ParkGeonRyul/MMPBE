...
from utils.logger_handler import login_log_callback
...
async def auth_callback(code,request: Request):
    ...
    if not code:
        await login_log_callback('LOGIN',"ANONYMOUS","N",client_ip, user_agent)
    ...
    async with AsyncClient() as client:
        ...
        await login_log_callback('LOGIN',user_data['mail'],"Y",client_ip, user_agent)
